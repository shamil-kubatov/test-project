...
class Paginator{
	...
	public function page_links($path='?',$ext=null)
	{
		...
		if ($this->_page > 1)
		    $pagination.= "<li><a href='".$path."$this->_instance=$prev"."$ext'>Предыдущий</a></li>";
		else
		    $pagination.= "<span class='disabled'>Предыдущий</span>";
		...
		if ($this->_page < $counter - 1)
		    $pagination.= "<li><a href='".$path."$this->_instance=$next"."$ext'>Следующий</a></li>";
		else
		    $pagination.= "<li><span class='disabled'>Следующий</span></li>";
		    $pagination.= "</ul>\n";       
		}
	return $pagination;
	}
